...
import net.sourceforge.subsonic.HistoryLogger;
...
public class PlaylistInputStream extends InputStream {
    ...
    private static final HistoryLogger HISTORY = HistoryLogger.getLogger(PlaylistInputStream.class);
    ...
    private void prepare() throws IOException {
        ...
        if (file == null) {
            ...
            HISTORY.info(player.getUsername() + " listening to \"" + file.getFile() + "\"");
