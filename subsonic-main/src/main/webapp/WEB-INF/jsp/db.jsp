...
<div style="float:left; text-align:left; width: 100%; height: 40px;display: block;">
<fmt:message key="db.tables" />
</div>

<div style="float:left;">
<form method="post" action="db.view" name="query">
    <textarea rows="10" cols="70" name="query" style="margin-top:1em">${model.query}</textarea>
...
<div style="left;">
    <h1 style="margin-top:250px">Result</h1>
...
<c:if test="${not empty model.error}">
    <h1 style="margin-top:250px">Error</h1>
