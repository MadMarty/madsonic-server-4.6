...
<table width="75%" class="ruleTable indent">
    <tr><td class="ruleTableHeader"><fmt:message key="help.version.title"/></td><td class="ruleTableCell">${versionString} &ndash; ${buildDateString} &ndash; (Moded by MadEvil)</td></tr>
...
<table cellpadding="2" class="detailmini">
...
<div class="forward"><a href="db.view" target="_blank"><fmt:message key="help.db"/></a></div>
