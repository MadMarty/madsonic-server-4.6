    ...
    <table style="border-collapse:collapse">
        <c:forEach items="${command.albums}" var="match" varStatus="loopStatus">
            ...
            <tr class="albumRow" ${loopStatus.count > 5 ? "style='display:none'" : ""}>
                ...
                <td ${loopStatus.count % 2 == 1 ? "class='bgcolor2'" : ""} style="padding-left:0.25em;padding-right:1.25em">
                    <a href="${mainUrl}"><str:truncateNicely upper="45">${match.firstChild.metaData.album}</str:truncateNicely></a>
                </td>

                <td ${loopStatus.count % 2 == 1 ? "class='bgcolor2'" : ""} style="padding-right:0.25em">
                    <span class="detail"><str:truncateNicely upper="45">${match.firstChild.metaData.artist}</str:truncateNicely></span>
                </td>
            </tr>
    ...
    <table style="border-collapse:collapse; empty-cells: show;">
        <c:forEach items="${command.songs}" var="match" varStatus="loopStatus">
            ...
            <tr class="songRow" ${loopStatus.count > 20 ? "style='display:none'" : ""}>
                ...
                <td ${loopStatus.count % 2 == 1 ? "class='bgcolor2'" : ""} style="padding-left:0.25em;padding-right:1.25em">
				<str:truncateNicely upper="60">${match.metaData.title}</str:truncateNicely>
				</td>

                <td ${loopStatus.count % 2 == 1 ? "class='bgcolor2'" : ""} style="padding-right:1.25em">
                    <a href="${mainUrl}"><span class="detail"><str:truncateNicely upper="45">${match.metaData.album}</str:truncateNicely></span></a>
                </td>

                <td ${loopStatus.count % 2 == 1 ? "class='bgcolor2'" : ""} style="padding-right:0.25em">
                    <span class="detail"><str:truncateNicely upper="45">${match.metaData.artist}</str:truncateNicely></span>
                </td>
            </tr>
