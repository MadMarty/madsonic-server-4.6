...
<div class="bgcolor2" style="position:fixed; top:0; width:100%;padding-top:0.1em">
    <table style="border-collapse: collapse;" class="123">
            ...
            <c:if test="${model.player.web}">
                 <td style="white-space:nowrap;"><a href="javascript:noop()" onclick="onPrevious()" id="rewind1" alt="Rewind">Rewind</a></td>
                 <td style="white-space:nowrap;"><a href="javascript:noop()" onclick="onNext(false)" id="forward1" alt="Forward">Forward</a></td>
             </c:if>

            <td style="white-space:nowrap;"><a href="javascript:noop()" onclick="onClear()" id="clear1" alt="Clear">Clear</a></td>
            <td style="white-space:nowrap;"><a href="javascript:noop()" onclick="onShuffle()" id="shuffle" alt="Suffle">Shuffle</a></td>

            <c:if test="${model.player.web or model.player.jukebox or model.player.external}">
                      <td style="white-space:nowrap;"><a href="javascript:noop()" onclick="onToggleRepeat()"><span id="bobcontent1-title" class="handcursor"></span>
<div id="bobcontent1" class="switchgroup1"></div>
