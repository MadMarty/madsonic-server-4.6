...
//              plugins:"metaviewer-1",
	...
	function ar_init(){
            ...
            var height = "${model.popout ? '85%' : '100%'}";
            swfobject.embedSWF("<c:url value="/flash/jw-player-5.9.swf"/>", "placeholder1", width, height, "9.0.0", false, flashvars, params, attributes);
        }
	</script><!--AR MOD END-->
</head>
...
<div style="padding-top:0.7em;padding-bottom:0.7em">
	...
	<!--AR MOD START-->
	<input type="hidden" id="customAspectRatioCheck" value="auto"><image id="customAspectRatioCheckImg" height="17px" width="17px" src="/script/aspectratio/ar_off.png" style="margin-top:-0.3em;padding-left:0.25em;margin-right:0.2em;cursor:pointer;display:inline" alt="change aspect ratio" title="enable manual aspectratio selection" onClick="ar_check()">
